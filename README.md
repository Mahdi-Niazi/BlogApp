...
```bash git clone https://github.com/Mahdi-Niazi/blog-app.git ``` 
...
2. For checking the linter errors in ruby files
```rubocop```
...
I would like to thank Microverse for his amazing design.
